...
export const calculateLocationPersonAverage = (
  ...
  if (prevalence === null) {
    console.log("No calculateLocationReportedPrevalence")
    return null
  }
  ...
  try {
    ...
    console.log("Error while calculating calculateLocationPersonAverage: " + e)
    return null
  }
}
...
export const calculate = (data: CalculatorData): number | null => {
  try {
    ...
    console.log("Error while calculating overall: " + e)
    return null
  }
}
